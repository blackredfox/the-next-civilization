  ...
  head: () => ({
    meta: [
      ...
      { title: "The Next Civilization — A publication on AI and human adaptation" },
      {
        name: "description",
        content:
          "Thoughtful essays on how artificial intelligence, robotics, capital, education and institutions reshape civilization over the coming decades.",
      },
      { name: "author", content: "The Next Civilization" },
      ...
      { property: "og:site_name", content: "The Next Civilization" },
